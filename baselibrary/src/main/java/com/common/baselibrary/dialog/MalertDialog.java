...
public class MalertDialog {
    ...
    public MalertDialog(Context context) {
        ...
        view=window.findViewById(R.id.v_title);
    ...
    public void setIsShowTitle(Boolean tag){
        if (tag) {
    ...
    public void setPositiveButton(String text, final View.OnClickListener listener)
    {
        ...
        textView.setTextColor(context.getResources().getColorStateList(R.color.center_blue_end));
