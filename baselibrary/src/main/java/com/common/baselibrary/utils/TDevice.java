...
public class TDevice {
    ...
    public static DisplayMetrics getDisplayMetrics() {
        return BaseLibraryApp.getApplication().getResources().getDisplayMetrics();
    }
    ...
    public static boolean hasInternet() {
        ConnectivityManager cm = (ConnectivityManager)BaseLibraryApp.getApplication()
    ...
    public static boolean isPortrait() {
        return BaseLibraryApp.getApplication().getResources().getConfiguration()
    ...
    public static boolean isTablet() {
        int s = BaseLibraryApp.getApplication().getResources().getConfiguration().screenLayout;
    ...
    public static int getVersionCode() {
        return getVersionCode(BaseLibraryApp.getApplication().getPackageName());
    }

    public static int getVersionCode(String packageName) {
        try {
            return BaseLibraryApp.getApplication()
                    .getPackageManager()
    ...
    public static String getVersionName() {
        try {
            return BaseLibraryApp.getApplication()
                    .getPackageManager()
                    .getPackageInfo(BaseLibraryApp.getApplication().getPackageName(), 0)
                    .versionName;
        } catch (PackageManager.NameNotFoundException ex) {
    ...
    public static void copyTextToBoard(String string) {
        ...
        ClipboardManager clip = (ClipboardManager) BaseLibraryApp.getApplication()
    ...
    public static boolean hasWebView(Context context) {
        if (mHasWebView != null) {
            if (!mHasWebView)
                ToastUtils.show("Not WebView for you phone");
            return mHasWebView;
        }
        try {
